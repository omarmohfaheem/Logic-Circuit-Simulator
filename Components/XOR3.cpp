...
void XOR3::Operate()
{
	...
	m_OutputPin[0].setStatus((STATUS)(((!GetInputPinStatus(1) * GetInputPinStatus(2)) + (!GetInputPinStatus(2) * GetInputPinStatus(1)) * !GetInputPinStatus(3)) + (!(!GetInputPinStatus(1) * GetInputPinStatus(2)) + (!GetInputPinStatus(2) * GetInputPinStatus(1)) * GetInputPinStatus(3))));
}
