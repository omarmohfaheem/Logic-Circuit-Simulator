...
class Connection :	public Component
{
	...
	int		DstPino;		//The Input pin to which this connection is linked
...
public:
	Connection();
	Connection(const GraphicsInfo &r_GfxInfo, Component *pS=NULL,Component *pD=NULL, int binary=0);
	...
	void setInLocation(GraphicsInfo x);
